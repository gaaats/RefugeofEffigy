...
import com.tocaboca.tocalifeworlde.urriila.BeamModel
...
class VebbbbbibiibiiActivity2 : AppCompatActivity() {
    private lateinit var bindBeam: ActivityVebbbbbibiibii2Binding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        bindBeam = ActivityVebbbbbibiibii2Binding.inflate(layoutInflater)
        beam = WebView(this)
        setContentView(beam)
